...
#read in files
setwd("~/Desktop/Coding/R/Masters_Project/expression_data")
...
setwd("~/Desktop/Coding/R/Masters_Project/") #set to the main folder of project
dir.create("./graphs") #make graphs folder... if it already exists it won't be duplicated 

dir.create("./graphs/results1") #create folder for figure 1 results
setwd("~/Desktop/Coding/R/Masters_Project/graphs/results1")
...
#graphs for figure 2 
setwd("~/Desktop/Coding/R/Masters_Project/") #set to the main folder of project
dir.create("./graphs/results2") #create folder for figure 2 results
setwd("~/Desktop/Coding/R/Masters_Project/graphs/results2")
...
setwd("~/Desktop/Coding/R/Masters_Project/") #set to the main folder of project
dir.create("./graphs/results3") #create folder for figure 2 results
setwd("~/Desktop/Coding/R/Masters_Project/graphs/results3")
...
#Boxplots ---- 
setwd("~/Desktop/Coding/R/Masters_Project/") #set to the main folder of project
dir.create("./graphs/results4") #create folder for figure 4 results
setwd("~/Desktop/Coding/R/Masters_Project/graphs/results4")
...
#Figure 5 LGT dist ---- 
setwd("~/Desktop/Coding/R/Masters_Project/") #set to the main folder of project
dir.create("./graphs/results5") #create folder for figure 2 results
setwd("~/Desktop/Coding/R/Masters_Project/graphs/results5")
...
setwd("~/Desktop/Coding/R/Masters_Project/") #set to the main folder of project
dir.create("./graphs/results6") #create folder for figure 2 results
setwd("~/Desktop/Coding/R/Masters_Project/graphs/results6")
