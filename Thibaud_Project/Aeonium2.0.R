...
ggsave("graphs/Aeonium/Aeonium_cana.png", units = c("px")) #this saves it within the working directory in the 'graphs' folder, giving it the name Aeonium_cana.png, the units = c pixel don't matter for this but adding width =, height = between 'units' and the file name allows for manual adjustment of plot sizes 
...
ggsave("graphs/Aeonium/Aeonium_chr.png",  units = c("px"))
...
ggplot(data = Aeonium_cun, aes (x = timepoint, fill = time_of_day)) +
  ...
  theme_bw()+
  facet_wrap('species_treatment')
ggsave("graphs/Aeonium/Aeonium_cun.png",  units = c("px"))
...
ggplot(data = Aeonium_dav, aes (x = timepoint, fill = time_of_day)) +
  ...
  theme_bw()+
  facet_wrap('species_treatment')
ggsave("graphs/Aeonium/Aeonium_dav.png", units = c("px"))
...
ggplot(data = Aeonium_gor, aes (x = timepoint, fill = time_of_day)) +
  ...
  theme_bw()+
  facet_wrap('species_treatment')
ggsave("graphs/Aeonium/Aeonium_gor.png",  units = c("px"))
...
ggplot(data = Aeonium_leu, aes (x = timepoint, fill = time_of_day)) +
  ...
  theme_bw()+
  facet_wrap('species_treatment')
ggsave("graphs/Aeonium/Aeonium_leu.png", units = c("px"))
...
ggplot(data = Aeonium_per, aes (x = timepoint, fill = time_of_day)) +
  ...
  theme_bw()+
  facet_wrap('species_treatment') 
ggsave("graphs/Aeonium/Aeonium_per.png", units = c("px"))
...
ggplot(data = Aeonium_stu, aes (x = timepoint, fill = time_of_day)) +
  ...
  theme_bw()+
  facet_wrap('species_treatment')
ggsave("graphs/Aeonium/Aeonium_stu.png", units = c("px"))
...
ggplot(data = Aeonium_und, aes (x = timepoint, fill = time_of_day)) +
  ...
  theme_bw()+
  facet_wrap('species_treatment') 
ggsave("graphs/Aeonium/Aeonium_und.png",  units = c("px"))
